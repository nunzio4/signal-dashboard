...
def _maybe_copy_seed_db():
    """If the working database doesn't exist, copy from seed.db if available."""
    db_path = settings.db_path
    seed_path = _backend_dir / "seed.db"

    if not db_path.exists() and seed_path.exists():
        db_path.parent.mkdir(parents=True, exist_ok=True)
        shutil.copy2(str(seed_path), str(db_path))
        logger.info(f"Copied seed database ({seed_path.stat().st_size // 1024} KB) to {db_path}")
    elif not db_path.exists():
        logger.info("No seed.db found, starting with empty database")
    else:
...
SEED_DATA_SERIES = [
    ...
    # ── Polymarket ──
    {
        ...
        "name": "Polymarket: US Recession 2026",
        "description": "Probability of a US recession by end of 2026 (Polymarket). Rising = recession more likely.",
        "thesis_id": "ai_deflation",
        "provider": "polymarket",
        "series_config": json.dumps({
            "slug": "us-recession-by-end-of-2026", "outcome_index": 0,
    ...
    {
        "id": "poly_unemployment_5pct",
        "name": "Polymarket: Unemployment ≥5%",
        "description": "Probability US unemployment reaches at least 5.0% in 2026 (Polymarket). Rising = job market weakening.",
        "thesis_id": "ai_job_displacement",
        "provider": "polymarket",
        "series_config": json.dumps({
            "slug": "how-high-will-us-unemployment-go-in-2026", "outcome_index": 0, "market_index": 0,
    ...
    {
        "id": "poly_unemployment_6pct",
        "name": "Polymarket: Unemployment ≥6%",
        "description": "Probability US unemployment reaches at least 6.0% in 2026 (Polymarket). High unemployment = severe displacement.",
        "thesis_id": "ai_job_displacement",
        "provider": "polymarket",
        "series_config": json.dumps({
            "slug": "how-high-will-us-unemployment-go-in-2026", "outcome_index": 0, "market_index": 2,
    ...
    {
        "id": "poly_ai_bubble_2026",
        "name": "Polymarket: AI Bubble Burst 2026",
        "description": "Probability of AI industry downturn by Dec 31, 2026 (Polymarket). Rising = datacenter overbuilding risk.",
        "thesis_id": "datacenter_credit_crisis",
        "provider": "polymarket",
        "series_config": json.dumps({
            "slug": "ai-bubble-burst-by", "outcome_index": 0, "market_index": 2,
    ...
    # ── Kalshi ──
    {
        "id": "kalshi_recession_2026",
        "name": "Kalshi: Recession 2026",
        "description": "Probability of a NBER-declared US recession in 2026 (Kalshi). Rising = economic downturn more likely.",
        "thesis_id": "ai_deflation",
        "provider": "kalshi",
        "series_config": json.dumps({"ticker": "KXRECSSNBER-26", "series_ticker": "KXRECSSNBER", "event_ticker": "KXRECSSNBER-26"}),
        "unit": "% Probability",
        "direction_logic": "higher_supporting",
    },
    {
        "id": "kalshi_unemployment_5pct",
        "name": "Kalshi: Unemployment ≥5%",
        "description": "Probability unemployment reaches 5% before 2027 (Kalshi). Rising = job losses expected.",
        "thesis_id": "ai_job_displacement",
        "provider": "kalshi",
        "series_config": json.dumps({"ticker": "KXU3MAX-27-5", "series_ticker": "KXU3MAX", "event_ticker": "KXU3MAX-27"}),
        "unit": "% Probability",
        "direction_logic": "higher_supporting",
    },
    {
        "id": "kalshi_unemployment_6pct",
        "name": "Kalshi: Unemployment ≥6%",
        "description": "Probability unemployment reaches 6% before 2027 (Kalshi). Higher threshold = severe displacement.",
        "thesis_id": "ai_job_displacement",
        "provider": "kalshi",
        "series_config": json.dumps({"ticker": "KXU3MAX-27-6", "series_ticker": "KXU3MAX", "event_ticker": "KXU3MAX-27"}),
        "unit": "% Probability",
        "direction_logic": "higher_supporting",
    },
    {
        "id": "kalshi_fed_rate_above_4",
        "name": "Kalshi: Fed Rate >4.0%",
        "description": "Probability Fed funds rate stays above 4.0% through Apr 2027 (Kalshi). Higher rates = tighter financial conditions.",
        "thesis_id": "datacenter_credit_crisis",
        "provider": "kalshi",
        "series_config": json.dumps({"ticker": "KXFED-27APR-T4.00", "series_ticker": "KXFED", "event_ticker": "KXFED-27APR"}),
        "unit": "% Probability",
        "direction_logic": "higher_supporting",
    },
    {
        "id": "kalshi_ai_takeover",
        "name": "Kalshi: US Gov AI Takeover",
        "description": "Probability US government takes control of an AI company/project before 2030 (Kalshi). Rising = regulatory risk.",
        "thesis_id": "datacenter_credit_crisis",
        "provider": "kalshi",
        "series_config": json.dumps({"ticker": "KXUSTAKEOVER-30", "series_ticker": "KXUSTAKEOVER", "event_ticker": "KXUSTAKEOVER-30"}),
        "unit": "% Probability",
        "direction_logic": "higher_supporting",
    },
    {
        "id": "kalshi_imf_recession",
        "name": "Kalshi: IMF Global Recession",
        "description": "Probability IMF declares global recession before 2027 (Kalshi). Rising = global economic stress.",
        "thesis_id": "ai_deflation",
        "provider": "kalshi",
        "series_config": json.dumps({"ticker": "KXIMFRECESS-27", "series_ticker": "KXIMFRECESS", "event_ticker": "KXIMFRECESS-27"}),
        "unit": "% Probability",
        "direction_logic": "higher_supporting",
    },
]
...
async def load_seed_data(db: aiosqlite.Connection):
    """No-op — seed data is now loaded via seed.db copy in get_db()."""
    pass
