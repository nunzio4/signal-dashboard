...
SEED_DATA_SERIES = [
    ...
    # ── Polymarket ──
    {
        ...
        "thesis_id": "ai_deflation",
        "provider": "polymarket",
        "series_config": json.dumps({"slug": "us-recession-by-end-of-2026", "outcome_index": 0}),
        "unit": "% Probability",
        "direction_logic": "higher_supporting",
    },
    {
        ...
        "thesis_id": "ai_job_displacement",
        "provider": "polymarket",
        "series_config": json.dumps({"slug": "how-high-will-us-unemployment-go-in-2026", "outcome_index": 0, "market_index": 0}),
        "unit": "% Probability",
        "direction_logic": "higher_supporting",
    },
    {
        ...
        "thesis_id": "ai_job_displacement",
        "provider": "polymarket",
        "series_config": json.dumps({"slug": "how-high-will-us-unemployment-go-in-2026", "outcome_index": 0, "market_index": 2}),
        "unit": "% Probability",
        "direction_logic": "higher_supporting",
    },
    {
        ...
        "thesis_id": "datacenter_credit_crisis",
        "provider": "polymarket",
        "series_config": json.dumps({"slug": "ai-bubble-burst-by", "outcome_index": 0, "market_index": 2}),
        "unit": "% Probability",
        "direction_logic": "higher_supporting",
    },
    # ── Kalshi ──
    {
        ...
        "thesis_id": "ai_deflation",
        "provider": "kalshi",
        "series_config": json.dumps({"ticker": "KXRECSSNBER-26"}),
        "unit": "% Probability",
        "direction_logic": "higher_supporting",
    },
    {
        ...
        "thesis_id": "ai_job_displacement",
        "provider": "kalshi",
        "series_config": json.dumps({"ticker": "KXU3MAX-27-5"}),
        "unit": "% Probability",
        "direction_logic": "higher_supporting",
    },
    {
        ...
        "thesis_id": "ai_job_displacement",
        "provider": "kalshi",
        "series_config": json.dumps({"ticker": "KXU3MAX-27-6"}),
        "unit": "% Probability",
        "direction_logic": "higher_supporting",
    },
    {
        ...
        "thesis_id": "datacenter_credit_crisis",
        "provider": "kalshi",
        "series_config": json.dumps({"ticker": "KXFED-27APR-T4.00"}),
        "unit": "% Probability",
        "direction_logic": "higher_supporting",
    },
    {
        ...
        "thesis_id": "datacenter_credit_crisis",
        "provider": "kalshi",
        "series_config": json.dumps({"ticker": "KXUSTAKEOVER-30"}),
        "unit": "% Probability",
        "direction_logic": "higher_supporting",
    },
    {
        ...
        "thesis_id": "ai_deflation",
        "provider": "kalshi",
        "series_config": json.dumps({"ticker": "KXIMFRECESS-27"}),
        "unit": "% Probability",
        "direction_logic": "higher_supporting",
    },
]
